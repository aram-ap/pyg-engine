...
def draw_scene(engine: Engine, game: SnakeGame) -> None:
    ...
    for x in range(GRID_WIDTH + 1):
        ...
        engine.draw_line(px, board_y, px, board_y + board_height, grid_color, thickness=1.0, layer=2)
    for y in range(GRID_HEIGHT + 1):
        py = board_y + y * CELL_SIZE
        engine.draw_line(board_x, py, board_x + board_width, py, grid_color, thickness=1.0, layer=2)
    ...
    if game.paused and not game.game_over:
        ...
        engine.draw_rectangle(center_x - 24.0, center_y - 10.0, 230.0, 54.0, Color(0.0, 0.0, 0.0, 0.45), layer=11)
        engine.draw_text("PAUSED", center_x, center_y, Color.WHITE, font_size=28.0, layer=12)
    ...
    if game.game_over:
        ...
        engine.draw_rectangle(center_x - 16.0, center_y - 16.0, 730.0, 62.0, Color(0.0, 0.0, 0.0, 0.60), layer=11)
        engine.draw_text(overlay_message, center_x, center_y, Color(1.0, 0.98, 0.90, 1.0), font_size=26.0, layer=12)
